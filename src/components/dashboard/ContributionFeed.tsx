  ...
  return (
    ...
    >
      <div style={{ paddingTop: 2 }}>
        <span style={{ display: 'inline-block', fontFamily: 'JetBrains Mono, monospace', fontSize: 9, fontWeight: 700, color: needsDarkText ? p.ink : '#fff', background: color, border: '1.5px solid ' + p.ink, borderRadius: 5, padding: '2px 8px', letterSpacing: '0.1em', whiteSpace: 'nowrap', textTransform: 'uppercase' }}>
          {item.category}
        </span>
      </div>
      <div style={{ minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 8 }}>
          <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 9, color: p.ink, opacity: 0.55, letterSpacing: '0.08em' }}>
            {kind}
          </span>
